...
public class Count_Non_Negative_Nodes_In_BinaryTree_Inorder{
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Total Non-Negative Nodes are  ");
        Count_Non_Negative(node);
    ...
    public static void Count_Non_Negative(Node temp) {

        if (temp == null) {
            return;
        }

        Count_Non_Negative(temp.left);
        Count_Non_Negative(temp.right);
